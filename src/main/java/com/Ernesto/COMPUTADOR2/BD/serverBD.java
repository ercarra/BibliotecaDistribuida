package com.Ernesto.COMPUTADOR2.BD;
...
public class serverBD {
  public static void main(String[] args) throws Exception {
    try {
      ...
      System.out.println("Inicando BD 2");

      ZMQ.Socket socket = context.createSocket(SocketType.REP);
      socket.bind("tcp://" + ipComputadora2 + ":5558");

      ZMQ.Socket socket2 = context.createSocket(SocketType.REQ);
      socket2.connect("tcp://" + ipComputadora1 + ":5557");
      String msg = "actualizar BD";
      socket2.send(msg.getBytes(ZMQ.CHARSET), zmq.ZMQ.ZMQ_DONTWAIT);
          ...
          if (solicitud.equals("devolucion")) {
            ...
            if (solicitud.equals("solicitud")) {
              ...
              if (solicitud.equals("actualizar")) {
                ...
                try {
                  archivo = new File(
                      "C:\\Users\\PC\\Desktop\\distr\\proyecto distribuidos\\ernest\\src\\main\\java\\com\\Ernesto\\COMPUTADOR2\\BD\\Libros.txt");
                ...
                if (solicitud.equals("1")) {
                  try {
                    ...
                    if (!(aux.equals("actualizar") || (aux.equals("solicitud")) || (aux.equals("devolucion"))
                        || (aux.equals("renovacion")))) {
  ...
  public static String solicitudLibro(String peticion) {
    ...
    respuesta = respuesta + "|Numero total de libros: " + totalNumero + "|libros en prestamo : " + librosPrestamo
        + "|libros disponibles para prestamo: " + (totalNumero - librosPrestamo);
    return respuesta;
  }
